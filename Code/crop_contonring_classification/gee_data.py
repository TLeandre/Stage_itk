...
def get_timeSeries_ndvi_evi(polygone: gpd.geodataframe.GeoDataFrame, start_date: str, end_date: str, ee:object) -> Union[list, list]:
...
def get_timeSeries_full_bands(polygone: gpd.geodataframe.GeoDataFrame, start_date: str, end_date: str, ee: object):
